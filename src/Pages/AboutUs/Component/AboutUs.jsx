...
export function AboutUs() {
    ...
    return (
        <div className="about-container">
            <h1 className="about-title"> Introducing Stelline: Where Family Extends Beyond Blood </h1>
            ...
            <div className="about-highlight">
                Welcome to Stelline, your trusted partner in nurturing the future!
            </div>
            <p className="about-desc">
            ...
            <div className="about-signoff">
                With Stelline, you're not just booking a service; you're adding a loving touch to your child's day, a touch that feels almost as tender as yours.
            </div>
            <div className="about-mission">
                    Stelline : Crafting Memories, One Smile at a Time. 💖
            </div>
